...
{
    /// <summary>
    /// Represents an attribute applied to a C union
    /// </summary>
    public class CUnionAttribute : SourceCodeEntity
    {
        /// <summary>
        /// Name of the attribute (e.g., "packed", "aligned")
        /// </summary>
        ...
        public CUnionAttribute Clone()
        {
            return new CUnionAttribute
            {
                Id = Id,
                Name = Name,
