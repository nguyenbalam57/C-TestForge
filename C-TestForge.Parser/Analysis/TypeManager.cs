    ...
    public class TypeManager : ITypeManager
    {
        ...
        private TypedefConfig CreateDefaultConfig()
        {
            return new TypedefConfig
            {
                ...
                {
                    new TypedefMapping { UserType = "UCHAR8", BaseType = "unsigned char", MinValue = "0", MaxValue = "255", Size = 1 },
                    new TypedefMapping { UserType = "UINT8", BaseType = "unsigned char", MinValue = "0", MaxValue = "255", Size = 1 },
                    new TypedefMapping { UserType = "UINT16", BaseType = "unsigned short int", MinValue = "0", MaxValue = "65535", Size = 2 },
                    new TypedefMapping { UserType = "UINT32", BaseType = "unsigned long", MinValue = "0", MaxValue = "4294967295", Size = 4 },
                    new TypedefMapping { UserType = "ULONG32", BaseType = "unsigned long", MinValue = "0", MaxValue = "4294967295", Size = 4 },
                    new TypedefMapping { UserType = "ULONG64", BaseType = "unsigned long long", MinValue = "0", MaxValue = "18446744073709551615", Size = 8 },
                    new TypedefMapping { UserType = "CHAR8", BaseType = "char", MinValue = "-128", MaxValue = "127", Size = 1 },
                    new TypedefMapping { UserType = "SCHAR8", BaseType = "signed char", MinValue = "-128", MaxValue = "127", Size = 1 },
                    new TypedefMapping { UserType = "SINT8", BaseType = "signed char", MinValue = "-128", MaxValue = "127", Size = 1 },
                    new TypedefMapping { UserType = "SINT16", BaseType = "short int", MinValue = "-32768", MaxValue = "32767", Size = 2 },
                    new TypedefMapping { UserType = "SINT32", BaseType = "long", MinValue = "-2147483648", MaxValue = "2147483647", Size = 4 },
                    new TypedefMapping { UserType = "SLONG32", BaseType = "long", MinValue = "-2147483648", MaxValue = "2147483647", Size = 4 },
                    new TypedefMapping { UserType = "SLONG64", BaseType = "long long", MinValue = "-9223372036854775808", MaxValue = "9223372036854775807", Size = 8 },
